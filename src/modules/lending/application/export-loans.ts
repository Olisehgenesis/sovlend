...
async function toExportRecords(prisma: PrismaClient, loans: LoanWithIncludes[]): Promise<ExportLoanRecord[]> {
  ...
  return loans.map((loan) => {
    ...
    return {
      ...
      principalWrittenOffMinor: loan.principalWrittenOffMinor,
      interestWrittenOffMinor: loan.interestWrittenOffMinor,
      feesWrittenOffMinor: loan.feesWrittenOffMinor,
      penaltiesWrittenOffMinor: loan.penaltiesWrittenOffMinor,
