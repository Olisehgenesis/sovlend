...
import { loadGroupPortfolioReport, serializeReportPayload } from "@/modules/reports/domain/insights-report";
...
export async function GET() {
  ...
  return NextResponse.json(serializeReportPayload(await loadGroupPortfolioReport(prisma, scope)));
}
