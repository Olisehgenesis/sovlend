import { Boxes, Building2, CircleDollarSign, Database, KeyRound, ShieldCheck, TrendingUp, UserRoundCog } from "lucide-react";
...
export default async function BackofficePage() {
  ...
  const [organizations, offices, users, investors, pendingAccessRequests, migrations] = await Promise.all([
    prisma.organization.count(),
    prisma.office.count(),
    prisma.user.count(),
    prisma.investorProfile.count(),
    prisma.investorOrganizationAccess.count({ where: { status: "REQUESTED" } }),
