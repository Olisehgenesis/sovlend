...
import { ProductMappingForm, SavingsDefaultsForm, SettlementMappingForm } from "@/components/accounting-mapping-forms";
...
export default async function AccountingSetupPage() {
  ...
  const [accounts, products, settlementAccounts, savingsDefaults] = await Promise.all([
