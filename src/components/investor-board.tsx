...
export function InvestorBoard({ investorName, accesses, commitments, btcExposure }: { investorName: string; accesses: Access[]; commitments: Commitment[]; btcExposure: BtcExposure[] }) {
