...
export function InvestorBoard({ investorName, accesses, commitments, btcExposure, portfolio, requestableOrganizations }: { investorName: string; accesses: Access[]; commitments: Commitment[]; btcExposure: BtcExposure[]; portfolio: Portfolio; requestableOrganizations: RequestableOrganization[] }) {
