      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            { exact: true, href: "/loans/applications?status=SUBMITTED", icon: FileClock, label: "Submitted (needs review)" },
            { exact: true, href: "/loans/applications?status=APPROVED", icon: FileClock, label: "Awaiting disbursement" },
            { exact: true, href: "/loans/applications", icon: Table2, label: "All applications" },
            { exact: true, href: "/loans?status=IN_ARREARS", icon: HandCoins, label: "In arrears" },
            { exact: true, href: "/loans?status=OVERPAID", icon: HandCoins, label: "Overpaid" },
            { exact: true, href: "/loans?status=WRITTEN_OFF", icon: HandCoins, label: "Written off" },
            { exact: true, href: "/loans?status=CLOSED", icon: HandCoins, label: "Closed" },
