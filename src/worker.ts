...
import { assessLoanInterestAccruals } from "@/modules/lending/application/assess-loan-interest-accruals";
...
const maintenanceWorker = new Worker(
  ...
  async (job) => {
    ...
    if (job.name === "assess-loan-interest-accruals") {
      return assessLoanInterestAccruals(prisma);
    }
